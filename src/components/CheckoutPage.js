    ...
    return ( 
       <>
        <Box sx={{ display: {xs: "block", md: "grid"}, overflowX: "hidden", gridTemplateColumns: "1fr 1fr", width: {xs: "100%", md: "100%"}, margin: "0 auto"}}>
            ...
            <Typography sx={{textAlign: "center", p: 2, color: "red"}}>Please take a screentshot of this Product and send to us via whatsapp along with your proof of payment</Typography>
